...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd `"$ContractPath`"; anvil --fork-url https://mainnet.base.org --fork-block-number 39760000 --chain-id 31337 --block-time 10 --allow-origin '*' --order fifo --auto-impersonate"
...
cast rpc anvil_setBalance 0xd0b53D9277642d899DF5C87A3966A349A798F224 0x8AC7230489E80000 --rpc-url http://127.0.0.1:8545;
cast rpc anvil_setBalance 0xeBf418Fe2512e7E6bd9b87a8F0f294aCDC67e6B4 0x8AC7230489E80000 --rpc-url http://127.0.0.1:8545;
cast rpc anvil_setBalance 0x501CEd8dFeC4Dcb6836b7BC0241AB1C3a93Ec434 0x8AC7230489E80000 --rpc-url http://127.0.0.1:8545;

Write-Host '--- Step 2: Funding Account (ERC20) ---' -ForegroundColor Magenta;
# 已修正為 Checksum 地址防止編譯錯誤
forge script script/FundAccount.s.sol --sig 'fundAll(address,uint256)' 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 5000000 --rpc-url http://127.0.0.1:8545 --broadcast --unlocked;

Write-Host '--- Step 3: Deploying Contracts ---' -ForegroundColor Magenta;
forge script script/DeployFork.s.sol --rpc-url http://127.0.0.1:8545 --broadcast --private-key 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80;
